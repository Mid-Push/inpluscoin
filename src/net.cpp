...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Inpluscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"inpluscoin.com", "172.18.181.228"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"inpluscointools.com", "testnet-seed.inpluscointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Inpluscoin is probably already running."), addrBind.ToString().c_str());
        else
